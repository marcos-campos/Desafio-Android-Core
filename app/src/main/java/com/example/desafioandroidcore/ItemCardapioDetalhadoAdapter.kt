...
class ItemCardapioDetalhadoAdapter(val listaDePratos: MutableList<ItemCardapioDetalhado>) : RecyclerView.Adapter<DetalheItemCardapioViewHolder>() {
    ...
    override fun onBindViewHolder(holder: DetalheItemCardapioViewHolder, position: Int) {
        ...
        imagemDoPratoOk.setImageResource(listaDePratos[position].imagemItem)

        val imagemDoPrato2Ok = holder.imageItemPrato2
        imagemDoPrato2Ok.setImageResource(listaDePratos[position].imagemItem2)

        val nameDoPrato2 = holder.nameDoPrato2
        nameDoPrato2.text = listaDePratos[position].nomePrato2
